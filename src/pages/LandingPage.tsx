...
const steps = [
  {
    ...
    desc: "Nome do casal, data especial e momentos que fazem o coração disparar.",
  },
  {
    icon: Image,
    title: "Adicione fotos e música",
    desc: "Escolha as fotos que contam a história de vocês e selecione a trilha sonora perfeita para embalar esse capítulo inesquecível.",
  },
  {
    icon: Share2,
    title: "Compartilhe o link",
    desc: "Um link exclusivo para eternizar esse momento. Compartilhe com quem faz seu coração sorrir!",
  },
];
...
const testimonials = [
  {
    name: "Camila, 24",
    text: "Meu namorado chorou quando abriu.",
    stars: 5,
  },
  {
    name: "Rafael, 28",
    text: "Fiz em menos 5 minutos e ficou mais bonito do que eu imaginava. Ela amou demais!",
    stars: 5,
  },
  {
    name: "Juliana, 22",
    text: "Usei pra pedir meu (agora) namorado em namoro. O melhor é o momento final, foi perfeito!!!",
    stars: 5,
  },
  {
    name: "Lucas, 26",
    text: "Minha namorada compartilhou com as amigas da facul e sobrou cobrança viu kkkk",
    stars: 5,
  },
  {
    name: "Beatriz, 19",
    text: "Chorei fazendo e chorei vendo a reação dele. É lindo demais!",
    stars: 5,
  },
  {
    name: "Pedro, 31",
    text: "Surpreendi minha esposa no nosso aniversário de casamento e ela ficou sem palavras.",
    stars: 5,
  },
];
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative bg-hero-gradient pt-32 pb-20 md:pt-44 md:pb-32 px-4 text-center overflow-hidden">
        ...
        >
          <h1 className="text-4xl md:text-6xl lg:text-6xl font-display font-bold text-white leading-tight mb-6">
            Transforme seu pedido em um momento {" "}
            <span className="inline-block">
              inesquecível
              <Heart className="inline w-6 h-6 md:w-12 md:h-12 ml-2 fill-white/80 text-white/80 -mt-2" />
            </span>
          </h1>
          <p className="text-lg md:text-xl text-white/85 font-body max-w-xl mx-auto mb-10">
            Em poucos minutos, crie uma surpresa única e encante quem faz seu coração bater mais forte
          </p>
          <Link to="/criar">
            <Button
              size="lg"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <motion.div variants={fadeUp} custom={0}>
              ...
              <p className="text-muted-foreground font-body text-lg max-w-md mx-auto">
                Fácil, rápido e cheio de emoção. Três passos para criar um momento inesquecível.
              </p>
            </motion.div>
          </motion.div>
          ...
          <div className="text-center mt-14">
            <Link to="/criar">
              <Button
                variant="outline"
                className="rounded-full px-8 py-5 text-base font-semibold border-primary text-primary hover:bg-primary hover:text-secondary gap-2"
              >
                Criar meu pedido
            ...
            {[
              {
                ...
                desc: "Com poucos cliques, crie uma surpresa única",
              },
              {
                icon: Sparkles,
                title: "Design premium",
                desc: "Um visual encantador, pensado nos mínimos detalhes para emocionar e surpreender.",
              },
              {
                icon: Heart,
                title: "Momento surpresa",
                desc: "O botão final revela sua mensagem com uma explosão de confetes e corações.",
              },
              {
                icon: Share2,
                title: "Link único",
                desc: "Compartilhe por WhatsApp, Instagram ou qualquer lugar com um clique.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
              ...
              >
                {[...testimonials, ...testimonials].map((t, i) => (
                  ...
                  >
                    ...
                    <p className="text-foreground font-body text-sm leading-relaxed italic mb-3">
                      "{t.text}"
                    </p>
        ...
        >
          <motion.div variants={fadeUp} custom={0}>
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-4 leading-tight">
              Encante quem você ama com um gesto único e cheio de carinho.
            </h2>
            <p className="text-white/80 font-body text-lg mb-10">
              Comece agora e crie uma surpresa que vai ficar para sempre na memória de quem você ama.
            </p>
            <Link to="/criar">
              <Button
                size="lg"
